    ...
    return(
        <div className="flex basis-full flex-wrap bg-sky-500 justify-between ">
                ...
                <div className="flex items-center">
                  <input type='search'  placeholder='Track Order' className='rounded-3xl text-sm sm:text-sm lg:text-lg md:text-base text-center bg-sky-50   border'/>
           
                  <span className="ml-1 cursor-pointer float-right  bg-sky-500  input-group-text flex  px-2 text-base font-normal text-gray-700 text-center whitespace-nowrap  " id="basic-addon2">
